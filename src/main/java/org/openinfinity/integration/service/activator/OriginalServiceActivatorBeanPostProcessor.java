...
//public class ServiceActivatorBeanPostProcessor implements DestructionAwareBeanPostProcessor, ApplicationContextAware, InstantiationAwareBeanPostProcessor {

public class OriginalServiceActivatorBeanPostProcessor implements ApplicationContextAware, InstantiationAwareBeanPostProcessor, Ordered {
	 ...
	 */
	private static final String SERVICE_ACTIVATOR_CONFIGURATION_QUERY_SQL = "SELECT INTERFACE, QUALIFIER FROM SERVICE_ACTIVATOR_CONFIGURATION";

	public OriginalServiceActivatorBeanPostProcessor() {}
...
//	public void setServiceActivatorConfiguration(
//			ServiceActivatorConfiguration serviceActivatorConfiguration) {
...
//	}
	...
	public Object postProcessAfterInitialization(final Object bean, String beanName) throws BeansException {
		CALL_ORDER++;
//		System.out.println("?????????? CALL_ORDER=" + CALL_ORDER + " , method=postProcessAfterInitialization");
//		loadBeansFromApplicationContext(bean);
		return bean;
	}
			...
			public ServiceActivatorRegistry mapRow(ResultSet resultSet, int rowNum) throws SQLException, SystemException {
				//while (resultSet.next()) {
					...
					try {
						...
						ServiceActivatorInvocationHandler invocationHandler = new ServiceActivatorInvocationHandler((ServiceActivator) applicationContext.getBean(qualifier), interfaceClass);
...
//	}
	...
	public Object postProcessBeforeInitialization(final Object bean, String name) throws BeansException {
		CALL_ORDER++;
		//System.out.println("?????????? CALL_ORDER=" + CALL_ORDER + " , method=postProcessBeforeInitialization");
		return bean;
	}

	public void postProcessBeforeDestruction(Object bean, String name) throws BeansException {
		CALL_ORDER++;
		//System.out.println("?????????? CALL_ORDER=" + CALL_ORDER + " , method=postProcessBeforeDestruction");
	}
	...
	public Object postProcessBeforeInstantiation(Class<?> beanClass,
		...
		System.out.println("?????????? CALL_ORDER=" + CALL_ORDER + " , method=postProcessBeforeInstantiation");
